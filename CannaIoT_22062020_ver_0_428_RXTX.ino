...
void setup() {
  ...
  // myRTC.setDS1302Time(03, 40, 13, 1, 22, 6, 2020);
...
void serialCommunication() {
  ...
  while (Serial.available() > 0) {
    ...
    //Setting Day Start Time Minutes
    ...
    if (incomingString == "values") {
      Serial.println("Displaying set parameters");
      delay(500);
      Serial.println(" - D A Y - ");
      Serial.print("Minimal Day Temperature: ");
      Serial.println(minDayTemp);
      delay(100);
      Serial.print("Maximal Day Temperature: ");
      Serial.println(maxDayTemp);
      delay(100);
      Serial.print("Minimal Day Humidity: ");
      Serial.println(minDayHumid);
      delay(100);
      Serial.print("Maximal Day Humidity: ");
      Serial.println(maxDayHumid);
      delay(100);
      Serial.print("Day starts at: ");
      Serial.print(dayStartTimeHours);
      Serial.println(" hours");
      Serial.print("Day starts at: ");
      Serial.print(dayStartTimeMinutes);
      Serial.println(" minutes");
      delay(100);

      Serial.println(" - N I G H T - ");
      delay(500);
      Serial.print("Minimal Night Temperature: ");
      Serial.println(minNightTemp);
      delay(100);
      Serial.print("Maximal Night Temperature: ");
      Serial.println(maxNightTemp);
      delay(100);
      Serial.print("Minimal Night Humidity: ");
      Serial.println(minNightHumid);
      delay(100);
      Serial.print("Maximal Night Humidity: ");
      Serial.println(maxNightHumid);
      delay(100);
      Serial.print("Night starts at: ");
      Serial.print(nightStartTimeHours);
      Serial.println(" hours");
      Serial.print("Night starts at: ");
      Serial.print(nightStartTimeMinutes);
      Serial.println(" minutes");
      delay(100);
    }
    ...
    if (incomingString == "hello") {
      Serial.print("\n");
      Serial.println("Hello there! This is CannaIoT masterMindAlpha.");
      delay(100);
    }
  }
}
